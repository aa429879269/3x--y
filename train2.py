    ...
    for e in range(epoch):  # batch_idx是enumerate（）函数自带的索引，从0开始
        ...
        if e%1000==0:
            ...
            if e % 50000==0:
                ...
                output[7] = x2
                output[8] = x3
                output.to_csv('data2/csv/eval_{}.csv'.format(e))
                torch.save(model, 'data2/model/model_{}.pkl'.format(e))
    return model
